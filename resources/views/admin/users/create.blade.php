...
@section('content')
    <div class="max-w-3xl space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Buat User Baru</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Isi formulir untuk membuat user baru</p>
            </div>
        </div>
