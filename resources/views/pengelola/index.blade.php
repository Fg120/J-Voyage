...
@section('content')
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6">Status Pengajuan Pengelola</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div class="pt-4 border-t">
                        ...
                        @if (in_array($pengelola->status, ['pending', 'rejected']))
                            <div class="mt-4">
                                <a href="{{ route('pengelola.edit') }}" class="inline-flex items-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-lg transition">
                                    Edit Pengajuan
                                </a>
                            </div>
                        @endif
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <a href="{{ route('pengelola.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-lg transition">
                        Ajukan Sekarang
                    </a>
                </div>
            @endif
