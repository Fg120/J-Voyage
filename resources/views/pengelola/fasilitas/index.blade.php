...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6 sticky top-6">
                ...
                <form action="{{ route('pengelola.fasilitas.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama" name="nama" placeholder="Contoh: Toilet Bersih, Musholla"
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6">
                ...
                @if (session('success'))
                    <div class="bg-green-100 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-4 text-sm flex items-center gap-2"
                        role="alert">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <div class="flex justify-end gap-3">
                                            ...
                                            <form action="{{ route('pengelola.fasilitas.destroy', $item->id) }}"
                                                method="POST" onsubmit="return confirm('Hapus permanen fasilitas ini?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
    ...
    {{-- BAGIAN 3: MODAL POPUP (Manual JS) --}}
        ...
        <div id="modal-edit-{{ $item->id }}"
            ...
            <div
                ...
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    <h3 class="font-bold text-gray-800 dark:text-white">Edit Fasilitas</h3>
