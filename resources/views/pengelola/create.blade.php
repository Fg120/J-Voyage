...
@section('content')
    <div class="bg-white rounded-2xl shadow-md p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Ajukan Sebagai Pengelola Wisata</h2>
        ...
        <form action="{{ route('pengelola.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="nama_wisata" name="nama_wisata" value="{{ old('nama_wisata') }}" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="kecamatan_id" name="kecamatan_id" required class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">
                ...
                <div>
                    ...
                    <input type="text" id="alamat_wisata" name="alamat_wisata" value="{{ old('alamat_wisata') }}" required
                        class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">
                    @error('alamat_wisata')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea id="deskripsi_wisata" name="deskripsi_wisata" rows="4" required
                        class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">{{ old('deskripsi_wisata') }}</textarea>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" id="kontak_wisata" name="kontak_wisata" value="{{ old('kontak_wisata') }}"
                            class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">
                        @error('kontak_wisata')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="jam_buka" name="jam_buka" value="{{ old('jam_buka') }}" placeholder="08:00"
                            class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">
                    </div>
                    <div>
                        <label for="jam_tutup" class="block font-semibold text-sm text-gray-700 mb-1">Jam Tutup</label>
                        <input type="text" id="jam_tutup" name="jam_tutup" value="{{ old('jam_tutup') }}" placeholder="17:00"
                            class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition">
                    </div>
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- File Izin -->
                        <div>
                            <label for="file_izin" class="block font-semibold text-sm text-gray-700 mb-1">File Izin Usaha <span class="text-red-500">*</span></label>
                            <input type="file" id="file_izin" name="file_izin" required accept=".pdf,image/*" class="w-full border-gray-300 rounded-lg">
                        ...
                        <!-- File KTP -->
                        <div>
                            <label for="file_ktp" class="block font-semibold text-sm text-gray-700 mb-1">File KTP <span class="text-red-500">*</span></label>
                            <input type="file" id="file_ktp" name="file_ktp" required accept=".pdf,image/*" class="w-full border-gray-300 rounded-lg">
                ...
                <div>
                    ...
                    <textarea id="alasan_pengajuan" name="alasan_pengajuan" rows="4" required
                        class="w-full border-gray-300 rounded-lg py-2.5 px-3 focus:border-indigo-500 focus:ring focus:ring-indigo-200 transition"
                        placeholder="Jelaskan mengapa Anda ingin menjadi pengelola wisata ini...">{{ old('alasan_pengajuan') }}</textarea>
