<footer class=" text-white pt-16">
    ...
    <div class="max-w-[400px] flex flex-col gap-5 ">
            <span class="flex items-center gap-3 ">
                <Img
                class="w-10 h-auto text-bolder " src="{{ Vite::asset('public/assets/images/logo.png') }}" alt="Logo">
                </Img>
            ...
            <div class="flex gap-3">
                <img src="{{ Vite::asset('public/assets/images/insta.png') }}" alt="">
                <img src="{{ Vite::asset('public/assets/images/Facebook.png') }}" alt="">
            </div>
        </div>
        <div>
        ...
        <div>
            ...
            <div class="gap-2 flex flex-col mt-5">
                <div class="flex gap-2">
                    <img src="{{ Vite::asset('public/assets/images/telp.png') }}" alt="" class="w-[22px] h-[22px]">
                    <p class="opacity-75">+62 821-452-954-436</p>
                </div>
                <div class="flex gap-2">
                    <img src="{{ Vite::asset('public/assets/images/mail.png') }}" alt="" class="w-[22px] h-[22px]">
                    <p class="opacity-75">info@jvoyage.com</p>
                </div>
                <div class="flex gap-2">
                    <img src="{{ Vite::asset('public/assets/images/loc.png') }}" alt="" class="w-[22px] h-[22px]">
