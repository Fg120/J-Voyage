@extends('layouts.public.sub', ['backUrl' => route('destinasi.show', $destinasi->id)])
        ...
        <div class="container mx-auto px-4 lg:px-24 pt-5">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-[65%]">
                    <form action="{{ route('transaksi.store', $destinasi->id) }}" method="POST"
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label for="nama" class="block font-semibold text-base text-[#171717] mb-2">Nama
                                        Lengkap</label>
                                ...
                                <div>
                                    <label for="email"
                                        class="block font-semibold text-base text-[#171717] mb-2">Email</label>
                                ...
                                <div>
                                    <label for="telepon" class="block font-semibold text-base text-[#171717] mb-2">Nomor
                                        Telepon</label>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label for="tanggal_kunjungan"
                                        class="block font-semibold text-base text-[#171717] mb-2">Tanggal Kunjungan</label>
                                ...
                                <div>
                                    <label for="jumlah" class="block font-semibold text-base text-[#171717] mb-2">Jumlah
                                        Orang</label>
                                ...
                                <div>
                                    <label for="catatan" class="block font-semibold text-base text-[#171717] mb-2">Catatan
                                        (Opsional)</label>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6  border border-gray-100">
                        ...
                        <div class="border-t border-[#E5E5E5] pt-4 space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold text-[#171717]">Rp
                        ...
                        <div class="border-t border-[#E5E5E5] pt-4 mt-4">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span class="font-extrabold text-2xl text-[#818CF8]" id="summary-total">Rp
                                    {{ number_format($destinasi->harga, 0, ',', '.') }}</span>
                            </div>
