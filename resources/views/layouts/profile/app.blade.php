    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        ...
        <div class="border-b border-gray-200 mb-8">
            <nav class="flex gap-4">
                ...
                <a href="{{ route('profile.history') }}" class="px-4 pb-4 text-lg font-semibold  {{ request()->routeIs('profile.history')   ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-gray-700' }}">
                    Riwayat Transaksi
                </a>
