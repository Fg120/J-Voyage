...
<div id="hs-application-sidebar"
    class="-translate-x-full transition-all duration-300 fixed top-0 start-0 bottom-0 z-[70] w-64 bg-gradient-to-b from-blue-600 to-blue-700 border-e border-blue-800 overflow-y-auto lg:block lg:translate-x-0"
    ...
    <div class="relative flex flex-col h-full max-h-full">
        <div class="px-6 pt-4">
            ...
            <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#" aria-label="Preline">
                <svg class="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M5 29.5V16.66C5 12.1534 8.58172 8.5 13 8.5C17.4183 8.5 21 12.1534 21 16.66C21 21.1666 17.4183 24.82 13 24.82H12" class="stroke-white" stroke="currentColor"
                        stroke-width="2" />
        ...
        <!-- Content -->
        <div class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-blue-700 [&::-webkit-scrollbar-thumb]:bg-blue-900">
                ...
                <ul class="flex flex-col space-y-1">
                    ...
                    @foreach ($menus as $menu)
                        ...
                        @if (isset($menu['children']))
                            ...
                            @endphp
                            <li class="hs-accordion {{ $isParentActive ? 'active' : '' }}" id="{{ Str::slug($menu['label']) }}-accordion">
                                <button type="button"
                                    ...
                                    {{ $menu['label'] }}
                                    <svg class="hs-accordion-active:block ms-auto hidden size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="m18 15-6-6-6 6" />
                                    </svg>

                                    <svg class="hs-accordion-active:hidden ms-auto block size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="m6 9 6 6 6-6" />
                                    </svg>
                                </button>

                                <div class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 {{ $isParentActive ? '' : 'hidden' }}">
