...
@section('content')
 <div class="bg-[#FAFAFA] min-h-screen font-poppins">
        ...
        <div class="bg-neutral-900 text-white   py-4 px-4 lg:px-24 sticky top-0 z-50">
            <a href="{{ route('profile.history') }}" class="inline-flex items-center gap-2 text-[#404040] hover:text-indigo-600 transition">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-800 text-lg">{{ \Carbon\Carbon::parse($transaksi->tanggal_kunjungan)->locale('id')->isoFormat('dddd, D MMMM Y')  }}</p>
                        </div>
                    </div>
