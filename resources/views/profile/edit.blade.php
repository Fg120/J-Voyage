            ...
            <div class="max-w-xl">
                ...
                <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        <button type="submit"
                            class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition">Simpan</button>
                ...
                <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="update_password_current_password"
                            class="block font-semibold text-sm text-gray-700 mb-1">Password Saat Ini</label>
                    ...
                    <div>
                        <label for="update_password_password"
                            class="block font-semibold text-sm text-gray-700 mb-1">Password Baru</label>
                    ...
                    <div>
                        <label for="update_password_password_confirmation"
                            class="block font-semibold text-sm text-gray-700 mb-1">Konfirmasi Password</label>
        ...
        <div class="bg-white rounded-2xl shadow-md p-8">
            <div class="max-w-xl">
                <header class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Setelah akun Anda dihapus, semua sumber daya dan data akan dihapus
                        secara permanen. Sebelum menghapus akun, harap unduh data atau informasi yang
                        ingin Anda simpan.</p>
                </header>
                    ...
                    <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                        <form method="post" action="{{ route('profile.destroy') }}">
                            ...
                            <p class="text-sm text-gray-600 mb-6">
                                ...
                                masukkan password Anda untuk mengkonfirmasi bahwa Anda ingin menghapus akun
                                secara permanen.
                            </p>
