        ...
        <div class="flex flex-col items-center mx-auto w-full max-w-2xl mt-5 px-4">
            ...
            <div class="w-full bg-white rounded-[30px] shadow-2xl overflow-hidden relative">
                ...
                <div class="bg-[#5D5FEF] p-6 pb-24 md:p-8 md:pb-28 relative"> {{-- pb-24 ditambahkan agar ada ruang untuk QR
                    ...
                    {{-- Hero Image --}}
                    <div
                        class="w-full h-40 md:h-48 rounded-2xl overflow-hidden shadow-lg mb-4 relative border-2 border-white/10">
                ...
                <div class="relative -mt-20 z-20 flex flex-col items-center justify-center">
                    <div class="bg-white p-3 rounded-2xl shadow-xl border border-gray-100">
                        <div class="bg-gray-200 w-40 h-40 rounded-xl flex items-center justify-center overflow-hidden">
                            <img
                                src="data:image/svg+xml;base64,{{ base64_encode(QrCode::format('svg')->size(150)->generate($transaksi->kode)) }}">
                        </div>
                    </div>
                    ...
                    @if($transaksi->scanned_at)
                        <div class="mt-3 bg-amber-100 border border-amber-300 rounded-xl px-4 py-3 flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-semibold text-amber-800 text-sm">Tiket Sudah Digunakan</p>
                                <p class="text-amber-700 text-xs">Di-scan pada
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-gray-800 text-sm">Rp
